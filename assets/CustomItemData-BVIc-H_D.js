import{p as u}from"./_-CJuvOKf9.js";import{j as n,u as d}from"./index-CZfnJ2UA.js";import{g as p,S as f}from"./utils-Ca8zZ7o2.js";const m=(e,t,o,a)=>{const s=[];if(o.toString().split("-").length===t)return[];for(let r=1;r<=(a??e);r++){const l={id:`${o}-${r}`,children:m(p(0,e),t,`${o}-${r}`),text:`${o}-${r}`};s.push(l)}return s},g=m(10,6,"Node",20),h=e=>n.jsxs("div",{children:[e.text," ",n.jsxs("span",{style:{color:"#1976d2"},children:["(",e.children.length,")"]})]}),I=()=>n.jsx(f,{defaultItems:g,height:600,collapsible:!0,indicator:!0,components:{ItemContent:h}}),x=`import { SortableTree, TreeItem as BaseTreeItem } from 'dnd-tree-sortable';
